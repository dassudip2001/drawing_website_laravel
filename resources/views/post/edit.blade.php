<x-app-layout>
                    ...
                    <div class="grid grid-cols-2">
                        ...
                        <div class="p-5" style="padding: 0 3rem;">
                            ...
                            <div class="flex items-center justify-center gap-2 px-4 mt-3" id="imagePreviewContainer">
                                {{-- Image preview --}}
                                {{-- <img class="rounded-md shadow-md" src="{{ asset($service->image_url) }}" width="40px" height="40px" alt=""> --}}
                            </div>
                            <input type="hidden" id="imageUrls" name="public_path"
                                value="{{ old('public_path', $post->public_path ?? '') }}">
                        </div>
    ...
    <script>
        ...
        let uploadedUrl = imageUrlsInput.value; // Load the existing image URL
        ...
        // Initialize the preview with the existing image
        if (uploadedUrl) {
            updateImagePreview();
        }
